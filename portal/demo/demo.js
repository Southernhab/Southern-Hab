(function () {
  ...
  views.work = function () {
    ...
    return '<div class="page">' +
      ...
      '<div class="metrics">' + metric('2026 Status', 'On track', 'major winter and spring work complete') + metric('Prescribed Fire', '150 ac', 'seven units completed in 2026') + metric('Timber & Cover Work', '57 ac', '42 thinned · 10 young cover · 5 openings') + metric('Next Milestone', 'Fall planting', 'September–October 2026') + '</div>' +
