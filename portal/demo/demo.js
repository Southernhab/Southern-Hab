(function () {
  ...
  var property = {
    ...
    "overlays": [
      [
        "NWI non-riverine wetland",
        "80 acres",
        "6.5%",
        "Planning constraint that overlaps land-cover classes."
      ],
      [
        "Field-supported bedding zones",
        "67 acres",
        "5.4%",
        "Three low-entry zones with repeated bed, track, camera, and winter thermal evidence."
      ],
      [
        "Managed early-cover footprint",
        "49 acres",
        "4.0%",
        "Current rotating footprint, increased from the 12-acre mapped baseline."
      ],
      [
    ...
    "projects": [
      ...
      [
        "2024",
        "Thinning and selective midstory control",
        "66 acres",
        "Complete",
        "Priority pine opened for timber growth, sunlight, and native groundcover"
      ],
      [
        "2025",
      ...
      [
        "2026",
        "Winter thermal drone survey",
        "430 sampled acres",
        "Complete",
        "Second standardized survey completed across six flight blocks"
      ],
      [
        "2026",
        "Annual prescribed-fire program",
    ...
    "budgets": [
      [
        2024,
        "Field verification and program foundation",
        52700,
        14900,
        37800
      ],
      ...
      [
        2026,
        "Fire rotation and habitat expansion",
        59200,
        20400,
        38800
      ],
      [
        2027,
        "Adaptive treatment and access work",
        53500,
        17000,
        36500
      ],
      [
        2028,
        "Complete targets and next-cycle inventory",
        49500,
        13300,
        36200
      ]
  ...
  function managementMap(compact) {
    return '<figure class="actual-map ' + (compact ? 'compact' : '') + '">' +
      ...
      '<div class="map-frame"><img src="' + mapPath + '" alt="Sanitized demonstration map showing the timber, habitat, access, water, and wildlife layers included in an owner account"></div>' +
      '<figcaption>This sanitized composite demonstrates the layers an owner receives: boundary, water, roads, openings, wetlands, treatment areas, bedding cover, and travel routes. It is not an acreage-scaled or legal survey exhibit.</figcaption>' +
    '</figure>';
  }
  ...
  views.map = function () {
    return '<div class="page">' +
      heading('Property Map', 'Verified resources and monitored habitat features across the 1,240-acre demonstration tract') +
      managementMap(false) +
      '<div class="grid-equal section-gap"><div class="panel"><div class="panel-head"><h2>Documented Layers</h2></div><div class="panel-body layer-list"><span><i class="wetland"></i>NWI wetland</span><span><i class="creek"></i>Creeks and drainages</span><span><i class="early"></i>Early-successional cover</span><span><i class="road"></i>Native / gravel roads</span><span><i class="boundary"></i>Property boundary</span></div></div><div class="panel"><div class="panel-head"><h2>Monitored Habitat Features</h2></div><div class="panel-body layer-list"><span><i class="bedding"></i>BED-1 through BED-5</span><span><i class="travel"></i>Four travel corridors</span><p class="mini-note">The bedding and travel layers began as desktop hypotheses. Bedding and travel layers begin as planning hypotheses and are retained only when cameras, field sign, or thermal observations support them. This demo map is a sanitized composite rather than an acreage-scaled legal exhibit.</p></div></div></div>' +
      limitation() +
    '</div>';
  };
